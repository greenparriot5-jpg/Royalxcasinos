  ...
  const articles = [
    {
      ...
      text: "Discover Royal X Casino and learn about its modern gaming platform, simple navigation, available features, and digital gaming experience.",
    },
    {
      icon: <FaGamepad />,
      category: "Gaming Guide",
      title: "How To Get Started With Royal X",
      text: "Learn the basic steps for getting started with Royal X, exploring the platform, understanding available games, and navigating your account.",
    },
    {
      icon: <FaLightbulb />,
      category: "Gaming Tips",
      title: "Tips For A Better Gaming Experience",
      text: "Explore useful gaming tips, learn game rules, understand platform features, and make informed decisions while enjoying online entertainment.",
    },
    {
      icon: <FaMobileAlt />,
      category: "Mobile Gaming",
      title: "Royal X On Mobile Devices",
      text: "Learn how Royal X can be explored on supported smartphones and tablets with a responsive interface designed for convenient mobile access.",
    },
    {
      icon: <FaShieldAlt />,
      category: "Platform Guide",
      title: "Understanding Your Royal X Account",
      text: "Understand the importance of your Royal X account, account settings, security practices, and the main features available to users.",
    },
    {
      icon: <FaStar />,
      category: "Rewards",
      title: "Understanding Bonuses & Promotions",
      text: "Learn how to review promotional offers, eligibility requirements, applicable terms, expiration details, and other conditions before participating.",
    },
    {
      icon: <FaRocket />,
      category: "Platform Updates",
      title: "Why A Smooth Interface Matters",
      text: "Discover why simple navigation, responsive design, organized menus, and a clean interface can improve the overall digital gaming experience.",
    },
    {
      icon: <FaGamepad />,
      category: "Beginner Guide",
      title: "Choosing Games That Suit You",
      text: "Learn how beginners can explore different gaming options, understand game rules, and choose entertainment options that match their interests.",
    },
    {
      icon: <FaCrown />,
      category: "Royal X Experience",
      title: "Exploring The Royal X Gaming Experience",
      text: "Explore the Royal X experience, including platform navigation, gaming features, mobile access, account information, and general player guidance.",
    },
  ];
